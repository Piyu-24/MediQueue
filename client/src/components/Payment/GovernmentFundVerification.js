        ...
        <div className="space-y-6">
          ...
          {selectedFundType && (
            <div className="bg-teal-50 border border-teal-200 p-4 rounded-lg">
              <h4 className="font-semibold text-teal-900 mb-2">{selectedFundType.name} Details</h4>
              <p className="text-sm text-teal-700 mb-3">{selectedFundType.description}</p>
              ...
              <div className="mt-3">
                <span className="font-medium text-teal-800">Eligibility Requirements:</span>
                <ul className="list-disc list-inside text-sm text-teal-700 mt-1">
          ...
          <button
            ...
            className="w-full py-3 px-6 bg-gradient-to-r from-teal-600 to-teal-700 text-white rounded-lg font-medium hover:from-teal-700 hover:to-teal-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200"
          >
            {verifying ? (
