...
const HealthCardDisplay = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Health Card */}
      <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl shadow-2xl p-5 sm:p-8 text-white relative overflow-hidden">
        {/* Background Pattern */}
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-6">
            <div>
              <h2 className="text-xl sm:text-2xl font-bold">Digital Health Card</h2>
              <p className="text-blue-100 text-sm sm:text-base">MediQueue Hospital System</p>
            </div>
            <div className="text-left sm:text-right">
              <div className="text-sm text-blue-100">Card Number</div>
              <div className="text-lg font-mono font-bold break-all">{healthCard.cardNumber}</div>
            </div>
          </div>
