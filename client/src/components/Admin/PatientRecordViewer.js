    ...
    <div className="max-w-7xl mx-auto">
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-4">
                    <div className="w-14 h-14 bg-gradient-to-br from-blue-100 to-blue-100 rounded-xl flex items-center justify-center">
      ...
      {selectedPatient && (
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          {/* Patient Header */}
          <div className="bg-gradient-to-r from-blue-50 to-gray-50 px-6 py-6 border-b">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-blue-500 rounded-xl flex items-center justify-center mr-4">
