          ...
          <div className="p-8">
                ...
                <div className="mb-8">
                  <div className="flex space-x-4">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all font-semibold flex items-center space-x-2 disabled:opacity-50 shadow-lg hover:shadow-xl"
                    >
                      ...
                      >
                        <div className="flex items-center justify-between">
                          ...
                          <button
                            ...
                            className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all text-sm font-semibold shadow-md"
                          >
                            Select Patient
                          </button>
                        </div>
            ...
            {activeTab === 'verify' && (
              <div>
                ...
                {/* Search and Filter */}
                <div className="bg-gradient-to-r from-blue-50 to-gray-50 rounded-xl p-4 mb-6 border border-blue-100">
                ...
                {loading ? (
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    {filteredPatientsForVerification.map((patient) => (
                      <div
                        key={patient._id}
                        className="bg-white rounded-xl shadow-md border-2 border-gray-100 p-6 hover:shadow-lg hover:border-blue-200 transition-all"
                      >
                          ...
                          {patient.identityVerificationStatus === 'pending' && (
                            <div className="flex flex-col space-y-2 ml-4">
                              <button
                                ...
                                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all text-sm font-semibold flex items-center space-x-2 shadow-md"
                              >
                ...
                {!selectedPatient ? (
                  <div className="text-center py-16 bg-gradient-to-br from-gray-50 to-blue-50 rounded-2xl border-2 border-dashed border-gray-300">
                    ...
                    <button
                      ...
                      className="px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all font-semibold shadow-lg"
                    >
                      Search for Patient
                    </button>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-gray-50 border-2 border-blue-200 rounded-xl p-6">
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="mt-4 pt-4 border-t-2 border-gray-200">
                                  ...
                                  {/* File Input */}
                                  <div className="mb-4">
                                    <label className="flex items-center justify-center w-full px-4 py-4 border-2 border-dashed border-blue-300 rounded-xl cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-all bg-white">
                                      <div className="text-center">
                                        <DocumentArrowUpIcon className="w-10 h-10 text-blue-500 mx-auto mb-2" />
                                  ...
                                  {selectedFiles[record._id] && selectedFiles[record._id].length > 0 && (
                                    <div className="space-y-3">
                                      ...
                                      <button
                                        ...
                                        disabled={loading}
                                        className="w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all font-bold disabled:opacity-50 shadow-lg flex items-center justify-center space-x-2"
                                      >
              ...
              <div className="p-8">
                ...
                <div className="space-y-6 mb-6">
                  ...
                  {selectedPatient.nicDocument && (
                    <div className="p-6 bg-gradient-to-r from-blue-50 to-gray-50 border-2 border-blue-200 rounded-xl">
