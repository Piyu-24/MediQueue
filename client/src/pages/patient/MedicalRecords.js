              ...
              {selectedRecord.prescriptions && selectedRecord.prescriptions.length > 0 && (
                <div className="bg-teal-50 border-2 border-teal-200 rounded-xl p-4">
                  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <p className="text-sm font-bold text-teal-900">Prescriptions ({selectedRecord.prescriptions.length})</p>
                  </div>
                  <div className="space-y-2">
                      ...
                      <div key={index} className="bg-white border border-teal-200 rounded-lg p-3">
                        <div className="flex items-start justify-between">
                          ...
                          {rx.refills !== undefined && (
                            <span className="ml-2 px-2 py-1 bg-teal-100 text-teal-700 text-xs rounded-full font-semibold">
                              {rx.refills} refills
                            </span>
                          )}
                        </div>
