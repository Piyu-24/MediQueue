            ...
            <div className="space-y-2">
              ...
              <div className="rounded-xl border-2 border-blue-200 bg-blue-50/70 p-4">
                ...
                <p className="mt-1 text-sm text-gray-600">
                  Healthcare staff accounts are created by hospital administration.
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
              ...
              <div className="space-y-1 text-sm text-blue-800">
                ...
                <p><span className="font-medium">Account Type:</span> Patient</p>
                ...
                <p className="text-xs text-blue-600 mt-2">• Access to appointment booking, medical records, and health card</p>
              </div>
            </div>
            ...
            <div className="flex justify-between mt-8">
              {currentStep > 1 && (
                <button
                  ...
                  className="btn-outline btn-lg rounded-xl transition-all duration-200 transform hover:scale-105 border-2 border-gray-200 bg-white/50 hover:bg-white/80"
                >
                  Previous
                </button>
              )}
              ...
              <div className="ml-auto">
                {currentStep < 3 ? (
                  <button
                    type="button"
                    onClick={handleNext}
                    className="btn-primary btn-lg rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center space-x-2"
                  >
                    <span>Next</span>
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="btn-success btn-lg rounded-xl transition-all duration-200 transform hover:scale-105 disabled:scale-100 shadow-lg hover:shadow-xl disabled:shadow-md flex items-center space-x-2"
                  >
                    {loading ? (
                      <>
        ...
        <div className="mt-8 text-center">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gradient-to-br from-blue-50 via-gray-50 to-blue-50 text-gray-500">
